...
public class Address {
    ...
    public boolean equals(Object o) {
        if (o == this) {
            ...
            return addressLine1.equals(add.addressLine1) &&
                    city.equals(add.city) && addressLine2.equals(add.addressLine2)
                    && state.equals(add.state) && zipcode.equals(add.zipcode);
        }
        return false;
    }
    ...
    public String toString() {
        return "Address{addressLine1='"+this.addressLine1+"', " +
                "addressLine2='"+this.addressLine2+"', city='"+this.city+
